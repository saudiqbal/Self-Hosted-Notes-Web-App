...
<span class="dropbtnClickable"><?php if(isset($current_Notebook)) { echo ' <svg width="14" height="14" viewBox="0 0 100 100"><polygon fill="#fff" points="20,15 80,50 20,85" /></svg> '. $current_Notebook; } ?> </span>
...
<a href="./NoteAdd.php?NoteBookID=<?php echo $NoteBookView;?>">Add New Note <svg viewBox="0 0 24 24" width="20" height="20" style="vertical-align: middle;line-height: 20px;transform: translateY(-1px);" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg></a>
</span>
</div>
</div>
