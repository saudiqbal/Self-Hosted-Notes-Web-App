...
<span class="header-title"><a href="./"><?php echo $Title;?></a> <svg width="14" height="14" viewBox="0 0 100 100"><polygon fill="#fff" points="20,15 80,50 20,85" /></svg> Notebook Rename<?php if (isset($Notebook_Name)) { echo ' <svg width="14" height="14" viewBox="0 0 100 100"><polygon fill="#fff" points="20,15 80,50 20,85" /></svg> '.$Notebook_Name; } ?></span>
</div>
</div>
