...
<span class="header-title"><a href="./"><?php echo $Title; echo '</a>'; echo ' <a href="NoteBookView.php?NoteBookView='.$NoteBookID.'"><svg width="14" height="14" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><polygon fill="#fff" points="20,15 80,50 20,85" /></svg> '. $row['NoteBook_name'];?></a></span>
